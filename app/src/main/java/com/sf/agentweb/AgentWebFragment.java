...
public class AgentWebFragment extends Fragment implements FragmentKeyDown {
    private AgentWeb mAgentWeb;//webview
    private ImageView mBackImageView;//返回按钮
    private View mLineView;//中间分割线
    private ImageView mFinishImageView;//关闭按钮
    private TextView mTitleTextView;//标题栏
    private ImageView mMoreImageView;//更多按钮
    private PopupMenu mPopupMenu;//更多悬浮界面
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAgentWeb = AgentWeb.with(this)//
                ...
                .setAgentWebWebSettings(WebDefaultSettingsManager.getInstance())//设置 AgentWebSettings
            ...
            new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    switch (item.getItemId()) {
                        ...
                        case R.id.copy:
                            if (mAgentWeb != null)
                                toCopy(AgentWebFragment.this.getContext(),
